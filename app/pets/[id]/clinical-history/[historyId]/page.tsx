    ...
    try {
        const { rows } = await client.query(
            `SELECT
                ...
                pet_id,
                esterilizado,
                TO_CHAR(ultima_celo, 'YYYY-MM-DD') as ultima_celo,
                gestas_camadas,
                vacunacion_completa,
                pruebas_virales,
                ...
                ecto_frecuencia,
                ecto_producto,
                TO_CHAR(ecto_ult_aplic, 'YYYY-MM-DD') as ecto_ult_aplic,
                endo,
                endo_producto,
                TO_CHAR(endo_ult_aplic, 'YYYY-MM-DD') as endo_ult_aplic,
                donde_vive,
                convive_animales,
                sale_exterior,
                fauna_silvestre,
                ...
                conducta,
                evolucion,
                TO_CHAR(evolucion_desde, 'YYYY-MM-DD') as evolucion_desde,
                cojera_dolor,
                convulsiones,
                inicio_convulsiones,
                frec_convulsiones,
